...
LOCK TABLES springlibrary.`book` WRITE;
INSERT INTO springlibrary.book(title,  price, total_quantity) VALUES ('Da Vinci Code', 166.25,3 ), 
											('Percy Jackson and the Lightning Thief', 276.00,1 ),
											('Angels And Demons', 232.75, 5 ),
											('Inferno', 74.40,3 ),
											('Heroes of Olympus: The Lost Hero', 299.00,4 ),
											('Immortals of Mehula', 325.00,1 );
UNLOCK TABLES;